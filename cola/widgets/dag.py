...
class GitDAG(standard.MainWindow):
    ...
    def __init__(self, context, params, parent=None):
        ...
        self.commits_selected.connect(self.set_commits)
        ...
        self.commits_selected.connect(self.graphview.set_commits)
        self.commits_selected.connect(self.treewidget.set_commits)
